(function() {
  ...
  _.memoize = function(func) {
    ...
    var returnFunc = function() {
      if (!(memoObj[JSON.stringify(arguments)] === undefined)) {
        return memoObj[JSON.stringify(arguments)];
      } else {
        var result = func(...arguments);
        memoObj[JSON.stringify(arguments)] = result;
        return result;
      }
    };
    return returnFunc;
  ...
  _.delay = function(func, wait) {
    setTimeout(func, wait, ...Array.from(arguments).slice(2));
  };
